  ...
  const actions = [
    {
      ...
      title: 'Sign Out',
      icon: 'log-out',
      description: 'Sign out of your Ukho account',
            ...
            >
              <View style={styles.actionHeader}>
                ...
                <View style={styles.actionContent}>
                  <ThemedText style={[styles.actionTitle, { color: theme.textMain }]}>
                    {action.title}
                  </ThemedText>
                  <ThemedText style={[styles.actionDescription, { color: theme.textDim }]}>
                    {action.description}
                  </ThemedText>
                </View>
